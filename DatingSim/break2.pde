void break2() {
    ...
    text("Although your stomach cries out in anguish, you ignore its wishes and run .", width / 2, 78.5 * height / 100);
    text("Your hunger sharply rises.", width / 2, 84.5 * height / 100);
